        ...
        <Reveal>
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <div className="flex w-full max-w-lg mx-auto bg-white/5 p-1 sm:p-1.5 rounded-lg sm:rounded-xl mt-8 border border-white/10 relative overflow-x-auto no-scrollbar">
              ...
              <div
                className="absolute top-1 sm:top-1.5 bottom-1 sm:bottom-1.5 bg-[#6F70DE] rounded-lg shadow-md transition-all duration-300 ease-out"
                style={{
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`relative z-10 px-3 sm:px-6 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors min-w-[100px] flex-1 text-center whitespace-nowrap cursor-pointer ${
            ...
            {currentPlans.map((plan) => (
              ...
              >
                ...
                <div className="mt-auto border-t border-white/10 pt-6">
                  ...
                  <button className={`w-full py-3.5 rounded-xl font-bold transition-all text-sm uppercase tracking-wide cursor-pointer ${plan.highlight ? 'btn-primary' : 'bg-white text-black hover:bg-gray-200'}`}>
                    Lo quiero
                  </button>
                </div>
              </div>
